...
import SimpleListChart from './index';
...
class SimpleListChartManager extends Component {
  variables = {
    sharedfilters: {
...
SimpleListChartManager.defaultProps = {
  backgroundColor: 'white',
  sharable: false,
  color: '#000000'
};

SimpleListChartManager.propTypes = {
...
export default SimpleListChartManager;
