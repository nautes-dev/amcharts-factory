...
const SolidGaugeContainer = styled.div`
  width: calc(100% - 10px);
...
class SolidGaugeChartManager extends Component {
  variables = {
    sharedfilters: {
      ...
      >
        {({ loading, error, data }) => {
          ...
          if (data) {
            ...
            return (
              <SolidGaugeContainer backgroundColor={this.props.backgroundColor}>
                <RowColTop>
...
SolidGaugeChartManager.defaultProps = {
  backgroundColor: 'white',
  sharable: false,
  color: '#000000'
};

SolidGaugeChartManager.propTypes = {
...
export default SolidGaugeChartManager;
