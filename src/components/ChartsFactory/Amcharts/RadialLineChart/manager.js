...
class RadialLineChartManager extends Component {
  variables = {
    sharedfilters: {
      ...
      >
        {({ loading, error, data }) => {
          ...
          if (data) {
            ...
            return (
              <RadialLineChartContainer backgroundColor={this.props.backgroundColor}>
                <RowColTop>
...
RadialLineChartManager.defaultProps = {
  backgroundColor: 'white',
  sharable: false,
  color: '#000000',
};

RadialLineChartManager.propTypes = {
...
export default RadialLineChartManager;
