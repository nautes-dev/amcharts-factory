...
import HorziontalXYChart from './index';
...
class HorziontalXYChartManager extends Component {
  variables = {
    sharedfilters: {
...
HorziontalXYChartManager.defaultProps = {
  backgroundColor: 'white',
  sharable: false,
  color: '#000000'
};

HorziontalXYChartManager.propTypes = {
...
export default HorziontalXYChartManager;
